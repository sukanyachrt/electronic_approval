                        ...
                        <div class="row">
                            ...
                            <div class="invoice p-3 mb-3">
                                <form action="#" method="post" id="form_doc">
                                    ...
                                    <button type="button" id="btnEditform" value="<?php echo $_GET['id'] ?>" class="btn btn-warning float-right" style="margin-right: 5px;">
                                        <i class="fas fa-download"></i> ยืนยันการแก้ไขข้อมูล
                                    </button>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    function dataTeacher() {
        ...
        if (id > 0) {
            $.ajax({
                url: "./../api/doc/edit.php?v=finddoc&id=" + id, // Replace with the URL of your data source
                type: "GET",
                dataType: "json",
                success: function(Res) {
                    console.log(Res)
                    ...
                    $('#major_id').val(datadoc.general_form_major_code);
                    $('#general_form_semester').val(datadoc.general_form_semester);
                    $('#general_form_year').val(datadoc.general_form_year);
                    $('#tel').val(datadoc.general_form_tel);
